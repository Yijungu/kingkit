...
CREATE INDEX idx_subscription_id ON payment_histories(subscription_id);
...
CREATE INDEX idx_subscription_id ON payment_failures(subscription_id);
...
CREATE INDEX idx_user_id ON scheduled_billing_triggers(user_id);
